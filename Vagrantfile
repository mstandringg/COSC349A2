...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "convert" do |convert|
    ...
    convert.vm.network "forwarded_port", guest: 80, host: 8081, host_ip: "127.0.0.1"
    convert.vm.network "private_network", ip: "192.168.2.13"
    convert.vm.synced_folder ".", "/vagrant", owner: "vagrant", group: "vagrant", mount_options: ["dmode=775,fmode=777"]
